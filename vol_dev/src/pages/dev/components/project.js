...
import defaultNP from "../img/charityIcon.png";
		...
		axios
			...
			.catch((error) => {
				if (!error.response) console.log(error);
					...
					if (error.response.data.message === "Profile doesn't exists!") {
	...
	return (
		<div className="panel-container">
			...
			<div className="proj-and-np">
				<div className="proj">
					...
					<div className="project-info">
						<span className="proj-title">{prjTitle}</span>
			...
			<div className="developers">
				{Object.entries(devProfiles).map(([key, value], i) => (
					<DevProfile user={value} key={i} />
				))}
			</div>
		</div>
	);
