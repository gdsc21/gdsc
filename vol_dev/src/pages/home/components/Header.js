		...
		<div className="home-info">
			...
			<div className="info">
				...
				<h4>
					...
					Not only will every line of code written go towards a worthy cause, but we have a gamified
					system that awards our developers with amazing products and opportunities.{" "}
				</h4>
			</div>
			<a href="/"> Join Our Community</a>
			<div>
				{images.map(function (image, index) {
					return <Logos key={index} image={image} />;
				})}
			</div>
